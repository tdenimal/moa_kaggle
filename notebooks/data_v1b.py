...
data_all = pd.concat([data_all["sig_id"], data_all[["cp_time","cp_dose"]],data_feats],axis=1)
...
train_df.to_csv("train_v1b.csv.gz",index=False,compression="gzip")
test_df.to_csv("test_v1b.csv.gz",index=False,compression="gzip")
