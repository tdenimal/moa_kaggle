...
def run_training(fold, seed):
    ...
    for epoch in range(EPOCHS):
       ...
       # print(f"FOLD: {fold}, EPOCH: {epoch}, train_loss: {train_loss}, valid_loss: {valid_loss}")
        ...
        if valid_loss < best_loss:
            ...
            torch.save(model.state_dict(), f"FOLD{fold}_m1_3.pth")
    ...
    model.load_state_dict(torch.load(f"FOLD{fold}_m1_3.pth"))
    model.to(device)
...
sub.to_csv("sub_v2_3.csv.gz",index=False,compression="gzip")
