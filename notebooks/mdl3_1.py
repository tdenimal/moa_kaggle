    ...
    def fit(self, X_train, y_scored_train, X_valid=None, y_valid=None, loss_fn=None,loss_tr=None,
        ...
        while (self.epoch < self.max_epochs and self.patience_counter < self.patience):
            ...
            if current_lr != self.scheduler._last_lr[0]:
                ...
                checkpoint = torch.load("best_checkpoint1.pth")
...
oof_csv3.to_csv("oof_v3_1.csv.gz",index=False,compression="gzip")
sub_mdl3.to_csv("sub_v3_1.csv.gz",index=False,compression="gzip")
